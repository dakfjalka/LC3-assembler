...
typedef _err_type (*_instruction_handler_type)(_line_type *, _label_type *, _machine_code_type *);
typedef _err_type (*_pseudo_op_handler_type)(_line_type *, _label_type *, _machine_code_type **);
